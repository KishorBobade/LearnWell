...
<html lang="zxx">
   <head>
      <title>LearnWell | Single Product</title>
                  ...
                  <div class="col-lg-8 single-right-left simpleCart_shelfItem">
                     ...
                     <div class="color-quality">
                        <div class="color-quality-right">
                           ...
                           <h5>Life-Time : <?php echo $row['Orientation'];?></h5>
                          
                        </div>
                     </div>
                     <div class="occasional">
                        <h5>Thinks Types : <?php echo $row['typename'];?></h5>
                       
                       <h5>Thinks Medium : <?php echo $row['amname'];?></h5>
                       <h5>Thinks Reference Number : <?php echo $row['RefNum'];?></h5>
